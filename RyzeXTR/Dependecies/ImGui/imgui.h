...
namespace ImGui
{
    ...
    IMGUI_API bool          MultiComboBoxLUA( const char* szLabel, std::vector< std::string > szDisplayName, std::vector<bool*> v );
    ...
    IMGUI_API bool          ComboLUA( const char* label, int* current_item, std::vector<std::string>& values, int popup_max_height_in_items = -1 );
