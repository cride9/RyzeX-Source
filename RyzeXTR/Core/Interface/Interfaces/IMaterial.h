...
public:
	ITexture* GetTexture()
	{
		return util::CallVFunc<ITexture*>(this, 1);
	}

	void SetFloat(float flValue)
	{
		util::CallVFunc<void>(this, 4, flValue);
	}

	void SetInt(int iValue)
	{
		util::CallVFunc<void>(this, 5, iValue);
	}

	void SetString(const char* szValue)
	{
		util::CallVFunc<void>(this, 6, szValue);
	}

	void SetVector(float x, float y)
	{
		util::CallVFunc<void>(this, 10, x, y);
	}

	void SetVector(float x, float y, float z)
	{
		util::CallVFunc<void>(this, 11, x, y, z);
	}

	void SetTexture(ITexture* pTexture)
	{
		util::CallVFunc<void>(this, 15, pTexture);
	}

	void SetVectorComponent(float flValue, int iComponent)
	{
		util::CallVFunc<void>(this, 26, flValue, iComponent);
	}
};
