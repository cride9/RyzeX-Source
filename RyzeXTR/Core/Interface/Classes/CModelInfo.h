...
public:
	...
	virtual void					GetModelMaterialColorAndLighting(const Model_t* pModel, const Vector& vecOrigin, const Vector& angles, Trace_t* pTrace, Vector& vecLighting, Vector& matColor) = 0;
	virtual void					GetIlluminationPoint(const Model_t* pModel, IClientRenderable* pRenderable, const Vector& vecOrigin, const Vector& angles, Vector* pLightingCenter) = 0;
